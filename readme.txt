=== Plugin Name ===
Contributors: tmertz
Tags: wp_mail, postmarkapp, replacement, postmark, mail, smtp,
Requires at least: 2.8
Tested up to: 3.1
Stable tag: 1.3.2

A simple plugin that replaces the default wp_mail function with PostMarkApp (<a href="http://postmarkapp.com/">http://postmarkapp.com/</a>).
== Description ==
...
1. Go to the admin page for PostMarkApp Mail Replacement and fill out the fields.
